...
public class history extends AppCompatActivity {
    private static String IP_ADDRESS = "ferrydraw.dothome.co.kr";
...
//    private EditText mEditTextConfirm;
    ...
    private void showResult(){
        ...
        String TAG_JSON="ferrydraw";
        String TAG_DATE = "Date";
        String TAG_PLACE = "Place";
//        String TAG_CONFIRM ="confirm";
...
//                String confirm = item.getString(TAG_CONFIRM);

                PersonalData personalData = new PersonalData();

                personalData.setMember_date(date);
                personalData.setMember_place(place);
//                personalData.setMember_confirm(confirm);
